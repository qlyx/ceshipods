#
#  Be sure to run `pod spec lint ceshi.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "澜海利奥"
  # s.authors            = { "澜海利奥" => "1099781379@qq.com" }
  # s.social_media_url   = "http://twitter.com/澜海利奥"
